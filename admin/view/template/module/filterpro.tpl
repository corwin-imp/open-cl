...
<div class="box">
  ...
  <div class="content">
  <div id="tabs" class="htabs"><a href="#tab_general">Общие</a><a href="#seo_tab">Сео</a></div>
		...
		<td>
			<table class="list" style="width: 600px; float: left">
				...
				<tr>
					...
					<td><input type="checkbox" name="filterpro_setting[theme_mega]" <?php if(isset($setting['theme_mega'])) echo " checked='checked'"; ?> id="theme_mega">
					</td>
				</tr>

				<tr>
					<td><label for="ajax_more_btn"><?php echo $text_ajax_more_btn?></label></td>
					<td><input type="checkbox" name="filterpro_setting[ajax_more_btn]" <?php if(isset($setting['ajax_more_btn'])) echo " checked='checked'"; ?> id="ajax_more_btn"><span>&#160;&#160;&#160;</span>
					<label for="pagination_hide"><?php echo $text_pagination_hide?></label>
					<input type="checkbox" name="filterpro_setting[pagination_hide]" <?php if(isset($setting['pagination_hide'])) echo " checked='checked'"; ?> id="pagination_hide"></td>
					
				</tr>
				
				<tr>
					<td><label for="ajax_scroll"><?php echo $text_ajax_scroll?></label></td>
					<td><input type="checkbox" name="filterpro_setting[ajax_scroll]" <?php if(isset($setting['ajax_scroll'])) echo " checked='checked'"; ?> id="ajax_scroll"></td>
				</tr>

				<tr>
					<td><label for="hide_hash"><?php echo $text_hide_hash?></label></td>
					<td><input type="checkbox" name="filterpro_setting[hide_window_hash]" <?php if(isset($setting['hide_window_hash'])) echo " checked='checked'"; ?> id="hide_hash"></td>
				</tr>
