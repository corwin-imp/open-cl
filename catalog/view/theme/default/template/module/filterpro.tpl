...
<div class="option_box">
	...
	<div class="collapsible" <?php if(!$expanded_manufacturer){echo 'style="display:none"';}?>>
		...
		<table>
			...
			<tr>
				<td>
					<input id="manufacturer_<?php echo $manufacturer['manufacturer_id']?>" <?php echo ( isset($manufacturer['seo_status'])) ? 'data-seo="' . $manufacturer['manufacturer_id'] . '"' : ''; ?> class="manufacturer_value filtered"
		...
		<div class="attribute_box <?php if($attr_group=="0") echo "option_box"; ?>">
			...
			<div  class="collapsible  " <?php if(!$attribute_value['expanded']){echo 'style="display:none"';}?>>
				...
				<table>
					...
					<tr>
						<td>
							<input  class="filtered a_name  <?php echo (isset($attribute_value['seo_status'])) ? 'attr_stat' : ''; ?>"
	...
	<div class="option_box">
		...
		<table class="collapsible" <?php if(!$option['expanded']){echo 'style="display:none"';}?>>
			...
			<tr>
				<td>
					<input <?php echo (isset($option_value['seo_st'])) ? 'data-seo="' .$option_value["seo_st"]. '"' : ''; ?> class="filtered option_value" id="option_value_<?php echo $option_value['option_value_id']?>"
...
<?php if(isset($loadmore_status)){ ?>
	  <div class="no_btn_more" id="load_more">
	        <div class="row text-center">
	            <a href="#" class="load_more">more</a>
	        </div>
	    </div>
...
<?php if(isset($loadscroll_status)){ ?>
<style type="text/css">
	.arrow-scroll-top {
